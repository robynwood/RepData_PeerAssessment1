...
##1.  Make a time series plot (i.e. type = "l") if the 5-minute interval (x-axis) and the average number of steps taken, averaged across all days (y-axis)
```{r}
...
hist(totalsteps$steps,
        ...
        ylab = "Frequency")  
```
The impact of our cleaning strategy is that:  ________.
